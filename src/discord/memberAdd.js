exports.sayHello = (member) => {
    member.guild.channels.find(role => role.name === "general").send(member.toString() + " Bienvenido al servidor **DayZ LAS**, usa el comando `!ayuda` para obtener más información.");
}
